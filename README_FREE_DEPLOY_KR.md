...
다음 두 영역의 안내 문구를 문장·의미 단위로 분리했습니다.

- AI 위임 수준: 위치 설명과 최종 승인 책임 문장을 각각 한 줄 단위로 표시
- 의사결정 5대 핵심요소 설계: 화면 위치, 단계별 자동작성 연계, 최종 보고서 반영 문장을 각각 분리

고정된 폭에서 문장 중간이 어색하게 끊기지 않도록 설명 영역 최대 폭과 줄간격도 조정했습니다.
